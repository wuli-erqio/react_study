...
* 作用: 在web应用程序中获取地理位置
* 说明: 地理位置API通过navigator.geolocation对象,通过getCurrentPosition方法获取
* 注意: 获取到的地伦理位置跟GPS,IP地址,WIFI和蓝牙的MAC地址,GSM/CDMS的ID有关
* 比如: 手机优先使用GPS定位,笔记本优先使用WIFI
```
